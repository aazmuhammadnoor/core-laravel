  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="box box-info collapsed-box">
        ...
        <div class="box-body">
          {!! Form::newCheckbox([8,4],'Username','username','',true,['required','data-form'=>'table_row']) !!}
    ...
    {{-- button --}}
    <div class="col-md-3">
      <a href="{{ url("backend/user/add") }}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> New</a>
    </div>
