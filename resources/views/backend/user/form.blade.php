	  ...
	  <div class="box box-info">
		...
		{!! Form::open(['url' => $url,'class' => 'form-horizontal', 'method' => 'post']) !!}
			<div class="box-body">
				...
				{!! Form::newPassword([2,4],'Password','password','',['required'],'<i class="fa fa-lock"></i>','start') !!}
				{!! Form::newPassword([2,4],'Re-Password','re-password','',['required'],'<i class="fa fa-lock"></i>','start') !!}
